...
require "mobile-and-tablet-fu/version"

Gem::Specification.new do |s|
  s.name        = "mobile-and-tablet-fu"
  s.version     = MobileAndTabletFu::VERSION
  s.platform    = Gem::Platform::RUBY
  s.authors     = ["Brendan Lim", "Ben Langfeld"]
  s.email       = ["brendangl@gmail.com, ben@langfeld.me"]
  s.homepage    = "https://github.com/benlangfeld/mobile-and-tablet-fu"
  ...
  s.rubyforge_project = "mobile-and-tablet-fu"

  s.files         = ["CHANGELOG", "MIT-LICENSE", "README.md", "lib/mobile-and-tablet-fu.rb", "lib/mobile-and-tablet-fu/helper.rb", "lib/mobile-and-tablet-fu/version.rb" ]
